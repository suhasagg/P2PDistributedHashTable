...
func (d *DHT) replyAnnouncePeer(addr net.UDPAddr, node *remoteNode, r responseType) {
	...
	//Peer priority based on distance
...
func (d *DHT) replyGetPeers(addr net.UDPAddr, r responseType) {
    ...
    //Similar nodes - hash distance - computation algorithm based on infohash as one parameter (logics can be refined and tuned for finding neighbours using different logics)
...
//Remote Node information for info hash
...
//Peer contact set for info hash
