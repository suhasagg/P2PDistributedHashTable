...
//Similar nodes based on multiple parameters one is
//1)IP Address (Geographically close peers)
//Other parameters which will lead to different inorder print (neighbours based on different domain)
