...
//Application of circular list
//Why one used for peer contact set
//One can reach one node from any node
...
//Used to contact alternate peers
...
// Reduce latency for fetching peer contact set for information hash
...
//For a particular peerContact, one can derive peer contact set
//Lru cache can maintains this KV information
//LRU cache layer optimisation Can reduce localActiveDownloads map iteration can save some latencies
