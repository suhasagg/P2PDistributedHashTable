...
//Mutiple criterias for determining sorting order in routing table
...
//Reachable flag for peer, contacted
//Refined reachable list
...
// Remote Node structure is getting updated - Information regarding Node (new refined structure with new information)
// Two meanings of information hash - Remote node information hash and torrent information hash
...
func (r *routingTable) kill(n *remoteNode, p *peerStore) {
	...
	r.nTree.cut(InfoHash(n.id), 0) //? Details of n tree to be explored
